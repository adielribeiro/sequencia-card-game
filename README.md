...
Este repositório contém uma implementação básica do jogo de cartas **Sequência**, descrito pelo utilizador, utilizando **React** no front‑end e **Node.js/Express com Socket.IO** no back‑end.  O objetivo é fornecer uma base funcional que permita jogar online em tempo real, com regras implementadass.
